...
from_clause : FROM {this_implicit_variable | identification_variable_declarations};
...
path_join : join_spec join_association_path_expression [AS] identification_variable [join_condition];
