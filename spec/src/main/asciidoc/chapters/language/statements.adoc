...
3. Optionally, one or more join clauses, as defined in <<joins>>, with syntax given by `#join#`, which may each contain a restriction with syntax given by `#join_condition#`.
