...
* The *Core level* defines the minimal portable subset.
* The *Extended level* expands on Core with SQL-oriented features such as joins, grouping, and subqueries.
* Providers targeting non-relational stores are expected to support the Core level. Relational providers are expected to support both Core and Extended.
* Developers seeking portability across providers should restrict themselves to the Core level.
```
