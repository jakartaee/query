...
NOTE: The precise behavior of numeric operators is outside the scope of this specification and varies according to the database and cleint programming language.
...
**TODO** what can we say in general about null values?
