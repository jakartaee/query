...
Any element of the result list of the join which does not contain a structure labelled by the alias `y` is taken to satisfy the restriction, even when the predicate would not be satisfied by that element.
