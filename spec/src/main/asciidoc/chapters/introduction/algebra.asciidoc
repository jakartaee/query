...
Many data stores do not allow such operations, and so this specification limits union, intersection, or complementation to apply to lists of identical type.
