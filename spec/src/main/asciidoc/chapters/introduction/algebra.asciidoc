...
2. For each distinct resulting value _t_ of the grouping tuple, a result sublist _l~t~_ is constructed containing every structure _r_ which produced that value of the grouping tuple.

3. Finally, the result list of the aggregation contains every such result sublist _l~t~_.
